...
object LeapRare: ItemSkill("leap", 35, IItemRarity.RARE, 1){
	override fun clientFunction(world: World, player: EntityPlayer, handIn: EnumHand) {
		...
		player.addVelocity(vx * 1.4, vy * 1.4, vz * 1.4)
	}
	...
	override fun serverFunction(world: World, player: EntityPlayer, handIn: EnumHand) {
		...
		player.addVelocity(vx.toDouble() * 1.4, vy.toDouble() * 1.4, vz.toDouble() * 1.4)
	}
}