...
object LightningUncommon: ItemSkill("lightning_uncommon", 45, IItemRarity.UNCOMMON){
		...
		GlobalScope.launch {
			repeat(6){
				...
				(world as WorldServer).addScheduledTask(){
					...
					if (entityList[it] !is EntityPlayerMP) entityList[it].attackEntityFrom(LightningDamage(player), 4F)
				}
				delay(166)
			}
		}
